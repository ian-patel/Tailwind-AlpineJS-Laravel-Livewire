<div class="w-full min-h-screen lg:static lg:max-h-full lg:overflow-visible">
    <div class="flex">
        <div class="w-full py-6">
            <div class="flex mx-auto overflow-hidden bg-white rounded-lg md:max-w-4xl">
                ...
                <div class="justify-self-center w-full max-w-4xl px-6 mx-auto xl:px-6 lg:ml-0 lg:mr-auto xl:mx-0">
                    @yield('content')
                </div>
