<div id="sidebar"
    class="fixed inset-0 hidden w-full h-full pt-16 -mb-16 bg-white border-b z-90 lg:-mb-0 lg:static lg:h-auto lg:overflow-y-visible lg:border-b-0 lg:pt-0 lg:w-1/4 lg:block lg:border-0 xl:w-1/5">

    <div id="navWrapper"
        class="h-full overflow-y-auto scrolling-touch bg-white lg:h-auto lg:block lg:relative lg:sticky lg:top-16 lg:bg-transparent">
        ...
        <nav id="nav"
            ...
            <div class="relative w-24 mb-8 -mx-2 lg:hidden">
                <select data-version-switcher=""
                    class="block py-1 pl-2 pr-8 text-base font-medium text-gray-500 bg-white appearance-none focus:outline-none focus:text-gray-800">
            ...
            <div class="mb-10">
                <a href="/docs/installation"
                    class="flex items-center px-2 py-1 -mx-2 font-medium text-gray-900 hover:text-gray-900">
                ...
                <a href="/components"
                    class="flex items-center px-2 py-1 mt-3 -mx-2 font-medium text-gray-600 lg:mt-1 hover:text-gray-900">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path class="text-gray-400 fill-current"
                ...
                <a href="/screencasts" data-external=""
                    class="flex items-center px-2 py-1 mt-3 -mx-2 font-medium text-gray-600 lg:mt-1 hover:text-gray-900">
                    <svg class="w-6 h-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                        <path class="text-gray-400 fill-current"
            ...
            <div class="mb-8">
                <h5 class="mb-3 text-sm font-bold tracking-wide text-gray-500 uppercase lg:mb-2 lg:text-xs">
                    Getting
                    Started</h5>
                <ul>
                    <li class="mb-3 lg:mb-1">
                        <a class="relative block px-2 py-1 -mx-2 font-medium text-gray-600 transition duration-200 ease-in-out hover:translate-x-2px hover:text-gray-900"
                            href="/docs/installation">
                            <span class="absolute inset-0 bg-teal-200 rounded opacity-0"></span>
                    ...
                    <li class="mb-3 lg:mb-1">
                        <a class="relative block px-2 py-1 -mx-2 font-medium text-gray-600 transition duration-200 ease-in-out hover:translate-x-2px hover:text-gray-900"
                            href="/docs/controlling-file-size">
                            <span class="absolute inset-0 bg-teal-200 rounded opacity-0"></span>
                            <span class="relative">Controlling File Size</span>
                        </a>
                    </li>
                    <li class="mb-3 lg:mb-1">
                        <a class="relative block px-2 py-1 -mx-2 font-medium text-gray-600 transition duration-200 ease-in-out hover:translate-x-2px hover:text-gray-900"
            ...
            <div class="mb-8">
                <h5 class="mb-3 text-sm font-bold tracking-wide text-gray-500 uppercase lg:mb-2 lg:text-xs">Core
                    Concepts</h5>
                <ul>
                    <li class="mb-3 lg:mb-1">
                        <a class="relative block px-2 py-1 -mx-2 font-medium text-gray-600 transition duration-200 ease-in-out hover:translate-x-2px hover:text-gray-900"
                    ...
                    <li class="mb-3 lg:mb-1">
                        <a class="relative block px-2 py-1 -mx-2 font-medium text-gray-600 transition duration-200 ease-in-out hover:translate-x-2px hover:text-gray-900"
                            ...
                            <span class="absolute inset-0 bg-teal-200 rounded opacity-0"></span>
                            <span class="relative">Pseudo-Class Variants</span>
                        </a>
                    </li>
                    <li class="mb-3 lg:mb-1">
                        <a class="relative block px-2 py-1 -mx-2 font-medium text-gray-600 transition duration-200 ease-in-out hover:translate-x-2px hover:text-gray-900"
                ...
                <ul>
                    <li class="mb-3 lg:mb-1">
                        <a class="relative block px-2 py-1 -mx-2 font-medium text-gray-600 transition duration-200 ease-in-out hover:translate-x-2px hover:text-gray-900"
                            ...
                            <span class="absolute inset-0 bg-teal-200 rounded opacity-0"></span>
                            <span class="relative">Screen Readers</span>
                        </a>
                    </li>
                </ul>
            </div>
