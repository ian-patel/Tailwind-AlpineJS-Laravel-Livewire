<div class="flex max-w-sm mx-auto overflow-hidden bg-white rounded-lg shadow-lg lg:max-w-4xl">
    <div class="hidden bg-cover lg:block lg:w-1/2" style="background-image: url('/images/register.jpeg');">
    </div>
    <div class="w-full px-6 py-8 md:px-8 lg:w-1/2">
        <form wire:submit.prevent="login" action="#" method="POST">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                <a href="{{ route('auth.register') }}" class="text-xs text-gray-500 uppercase hover:underline">
                    or sign up
                </a>
                <span class="w-1/5 border-b md:w-1/4"></span>
            </div>
